...
# ==========================================
# ⭐ LEADERBOARD - DYNAMIC ACHIEVEMENTS (Top 1=4, Top 2=3, Top 3=2, 4-10=1)
# ==========================================
...
"""
            ...
            # Priority 1: If player has SAVED selected achievement -> show that
...
"""
                ...
                # ✅ Priority 2: Get rare achievements (ultra_rare, legendary, mythic)
                rare = get_rare_achievements(unlocked)
                
                # ✅ Top 1 = 4 achievements, Top 2 = 3, Top 3 = 2, Rest = 1
                if i == 0:  # Top 1
                    show_count = 4
                elif i == 1:  # Top 2
                    show_count = 3
...
"""
                    ...
                    # ✅ If no rare achievements, show random unlocked
                    if unlocked:
