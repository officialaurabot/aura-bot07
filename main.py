# ==========================================
# 🌌 AURA BOT v7.0 - DOPAMINE HIT ADDED
# ==========================================
...
# WIN STICKERS (Celebration - Dopamine Hit)
WIN_STICKERS = [
    "🎉🎊🎉 *YOU'RE A LEGEND!* 🎉🎊🎉\n\n🏆 MASTER WINNER! 🏆",
    "🎉🎊🎉 *INCREDIBLE!* 🎉🎊🎉\n\n👑 KING OF PREDICTIONS! 👑",
    "🔥🔥🔥 *ON FIRE!* 🔥🔥🔥\n\n⭐ EPIC WIN! ⭐",
...
# LOSS STICKERS (Motivational - Keep Playing)
LOSS_STICKERS = [
    "💪💪💪 *LEGEND IN MAKING!* 💪💪💪\n\n😅 SO CLOSE! TRY AGAIN!",
    "💪💪💪 *KEEP GOING!* 💪💪💪\n\n💪 YOU GOT THIS!",
    "🔄🔄🔄 *NEXT ROUND!* 🔄🔄🔄\n\n💪 CHAMPION RISING!",
...
# SHORT WIN MESSAGES (Stats ke saath show hoga)
WIN_SHORT = [
    "🏆 VICTORY!",
    "👑 ROYAL WIN!",
    "⭐ EPIC WIN!",
...
# SHORT LOSS MESSAGES (Stats ke saath show hoga)
LOSS_SHORT = [
    "😅 SO CLOSE!",
    "💪 KEEP GOING!",
    "🔄 NEXT TIME!",
...
def get_random_win_short():
    return random.choice(WIN_SHORT)

def get_random_loss_short():
    return random.choice(LOSS_SHORT)
...
# ==========================================
# HANDLE RESULT - WITH DOPAMINE HIT (STICKERS)
# ==========================================
    ...
    try:
        ...
        if text in ["🔴 BIG", "🔵 SMALL"]:
            ...
            if win:
                ...
                # Short message for stats
                win_short = get_random_win_short()
                result_text = f"✅ {win_short}"
                ...
                # Short message for stats
                loss_short = get_random_loss_short()
                result_text = f"💪 {loss_short}"
