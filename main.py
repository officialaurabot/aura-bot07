...
# ==========================================
# ⭐ FAKE USERS DATA - UPDATED WITH MORE PLAYS
# ==========================================

FAKE_USERS = [
    {"name": "Manoj Tiwari", "username": "manoj_tiwari", "win": 50, "loss": 30},
    {"name": "Arjun Mehta", "username": "arjun_mehta", "win": 43, "loss": 25},
    {"name": "Suresh Rao", "username": "suresh_rao", "win": 37, "loss": 20},
    {"name": "Vikram Reddy", "username": "vikram_reddy", "win": 32, "loss": 18},
    {"name": "Deepak Verma", "username": "deepak_verma", "win": 32, "loss": 15},
    {"name": "Amit Singh", "username": "amit_singh", "win": 25, "loss": 12},
    {"name": "Rahul Joshi", "username": "rahul_joshi", "win": 23, "loss": 10},
    {"name": "Rajesh Kumar", "username": "rajesh_kumar", "win": 20, "loss": 8},
    {"name": "Priya Sharma", "username": "priya_sharma", "win": 15, "loss": 5},
    {"name": "Pooja Desai", "username": "pooja_desai", "win": 15, "loss": 6},
    {"name": "Ravi Kumar", "username": "ravi_kumar", "win": 100, "loss": 50},
    {"name": "Neha Singh", "username": "neha_singh", "win": 80, "loss": 40},
    {"name": "Vikram Shah", "username": "vikram_shah", "win": 200, "loss": 100},
    {"name": "Pooja Reddy", "username": "pooja_reddy", "win": 150, "loss": 75},
    {"name": "Amit Verma", "username": "amit_verma", "win": 60, "loss": 30},
]
...
def initialize_fake_users():
    ...
    for fake in FAKE_USERS:
        ...
        if not exists:
            ...
            # ─── RARE ACHIEVEMENTS ───
            # Top 10 wale fake users ko "🌟 STAR PLAYER"
            if total_plays >= 30:
...
# ==========================================
# ⭐ LEADERBOARD FUNCTION WITH ACHIEVEMENTS DISPLAY - FIXED
# ==========================================
...
"""
            ...
            # ⭐ LEADERBOARD ACHIEVEMENTS - FIXED
            if user_id in users:
