...
async def broadcast_callback(update, context):
    try:
        ...
        if data == "broadcast_send":
            ...
            # Send to all users
            count = 0
            await query.edit_message_text("⏳ *Broadcasting...*", parse_mode='Markdown')
...
"""
            ...
            context.user_data['broadcast_again'] = True
            context.user_data['broadcast_mode'] = True
            await query.edit_message_text(
                "📝 *Write Your Message:*\n━━━━━━━━━━━━━━━━━━━━━━\n\n"
                "✏️ Type your message below\n"
                "📤 Then click 'SEND TO ALL'",
                parse_mode='Markdown'
            )
...
# ==========================================
# ⭐ BROADCAST - ULTIMATE FIX (Auto-Send)
# ==========================================
async def broadcast(update, context):
    try:
        ...
        # If admin clicks "New Broadcast" from inline button
        if context.user_data.get('broadcast_again'):
            context.user_data['broadcast_again'] = False
            context.user_data['broadcast_mode'] = True
        ...
        if context.user_data.get('broadcast_mode'):
            ...
            # Show inline buttons with the message
            inline_keyboard = InlineKeyboardMarkup([
                [InlineKeyboardButton("📤 SEND TO ALL", callback_data="broadcast_send")],
                [InlineKeyboardButton("🏠 HOME", callback_data="broadcast_home")]
            ])
            
            await update.message.reply_text(
                f"📝 *Your Message:*\n━━━━━━━━━━━━━━━━━━━━━━\n{msg}\n━━━━━━━━━━━━━━━━━━━━━━\n\n"
                "📤 Click 'SEND TO ALL' to send\n"
                "🏠 Click 'HOME' to cancel",
                parse_mode='Markdown',
                reply_markup=inline_keyboard
            )
            return
        ...
        await update.message.reply_text(
            "📝 *Write Your Message:*\n━━━━━━━━━━━━━━━━━━━━━━\n\n"
            "✏️ Type your message in the chat below\n"
