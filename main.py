...
ADMIN_IDS = [5901835425, 6467765686]
...
# ⭐ STATS BANNER - Without Achievements/Streak
...
async def achievements(update, context):
    try:
        ...
        rank, rank_emoji = get_rank(level)
        achievements_list = get_achievements(win, loss, level)
