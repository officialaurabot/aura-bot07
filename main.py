...
# ==========================================
# ⭐ FIXED: BUY MEMBERSHIP WITH ERROR HANDLING
# ==========================================
...
# ==========================================
# ⭐ FIXED: PLAY WITH LOADING ANIMATION
# ==========================================
async def play(update, context):
    try:
        ...
        # Loading animation - gives server time to process
...
# ==========================================
# ⭐ FIXED: TIMER SELECT WITH LOADING
# ==========================================
    ...
    try:
        ...
        if not context.user_data.get('waiting_timer'):
            if text in ["⏱ 30s", "⏱ 1m", "⏱ 2m", "⏱ 5m"]:
                await update.message.reply_text("❌ Please start game first: ▶️ PLAY")
            return
        
        timer_map = {"⏱ 30s": "30", "⏱ 1m": "60", "⏱ 2m": "120", "⏱ 5m": "300"}
        
        if text in timer_map:
            # Loading animation - gives server time
            loading_msg = await update.message.reply_text("⏳ Setting timer...")
            await asyncio.sleep(0.5)
            await loading_msg.delete()
            ...
            await update.message.reply_text("❌ Please select a valid timer option!", reply_markup=timer_menu)
    except Exception as e:
        logger.error(f"Timer select error: {e}")
...
# ==========================================
# ⭐ FIXED: PROCESS ANALYSIS WITH LOADING
# ==========================================
...
def main():
    ...
    print("✅ Loading animations added!")
    print("=" * 50)
