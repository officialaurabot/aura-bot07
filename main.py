...
# ==========================================
# ⭐⭐⭐ ULTIMATE FIX: HANDLE BUTTONS (BACK & HOME WORKING)
# ==========================================
async def handle_buttons(update, context):
    try:
        ...
        # ⭐⭐ SAB SE PEHLE: BACK & HOME BUTTONS CHECK ⭐⭐
        if text == "🔙 BACK":
            context.user_data.clear()
            user_id_int = int(uid)
            if user_id_int in SUPER_ADMIN_IDS:
        ...
        # ⭐ HOME button - Same as BACK but goes to main menu
        if text == "🏠 HOME":
            context.user_data.clear()
            user_id_int = int(uid)
            # Check if user is admin or normal
            if user_id_int in SUPER_ADMIN_IDS:
                kb = super_admin_menu
            elif user_id_int in ADMIN_IDS:
                kb = admin_menu
