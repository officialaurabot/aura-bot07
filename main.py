# ==========================================
# 🌌 AURA BOT v7.0 - FINAL COMPLETE (FIXED)
# ==========================================
    ...
    try:
        ...
        if users[uid].get('free_trial_used', False):
            ...
            if expiry_str:
                expiry = datetime.fromisoformat(expiry_str)
                if datetime.now() < expiry:
                    # ⭐ FREE TRIAL - SHOW PASSKEY BANNER
                    context.user_data['verified'] = False
                    ...
                    # Trial expired - remove from VIP and show membership
                    if uid in vip:
                        del vip[uid]
                        save("vip.json", vip)
                    await update.message.reply_text(
...
# ==========================================
# HANDLE RESULT NUMBER - FIXED (Direct Next Step)
# ==========================================
async def handle_result_number(update, context):
    try:
        ...
        if not context.user_data.get('waiting_result_number'):
            ...
            # Period daalne ke baad yeh state True hona chahiye
        ...
        if text in number_map:
            ...
            # ⭐ CRITICAL FIX: Clear waiting states and process analysis
            ...
            # ⭐ DIRECTLY CALL PROCESS ANALYSIS - NO DELAY
