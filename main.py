...
async def auto_delete_message(context, chat_id, message_id, delay=4):
    try:
...
async def send_and_auto_delete(update, context, text, delay=4, parse_mode=None, reply_markup=None):
    try:
...
# ==========================================
# ⭐ HANDLE RESULT - UPDATED WITH DOPAMINE HIT (4 SECOND AUTO-DELETE)
# ==========================================
...
"""
                ...
                await send_and_auto_delete(update, context, unlock_msg, delay=4, parse_mode='Markdown')
            
            streak = update_streak(uid, win)
            
            # ✅ ========== DOPAMINE HIT SYSTEM (4 SECOND AUTO-DELETE) ==========
            if win:
...
"""
                await send_and_auto_delete(update, context, rank_up_msg, delay=4, parse_mode='Markdown')
...
def main():
    ...
    print("🎯 Dopamine Hit: ENABLED (Win/Loss Emojis - 4s Auto-Delete)")
    print("🔮 BIG/SMALL Analysis Algorithm: ENABLED (Self-Learning)")
    print("⏰ Auto-Delete: 4 SECONDS (Dopamine Emojis)")
    ...
    print("✅ DOPAMINE HIT EMOJIS: 5 WIN + 5 LOSS Variations (4s Auto-Delete)")
