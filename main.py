...
def get_random_rare_achievement(unlocked_list):
    ...
    # If no rare, return any unlocked achievement
    if unlocked_list:
...
async def auto_delete_message(context, chat_id, message_id, delay=6):
    try:
...
async def send_and_auto_delete(update, context, text, delay=6, parse_mode=None, reply_markup=None):
    try:
...
# ==========================================
# ⭐ HANDLE RESULT - UPDATED WITH DOPAMINE HIT
# ==========================================
...
"""
                ...
                await send_and_auto_delete(update, context, unlock_msg, delay=6, parse_mode='Markdown')
...
"""
                await send_and_auto_delete(update, context, rank_up_msg, delay=6, parse_mode='Markdown')
...
def main():
    ...
    print("🎯 Dopamine Hit: ENABLED (Win/Loss Emojis - 6s Auto-Delete)")
    print("🔮 BIG/SMALL Analysis Algorithm: ENABLED (Self-Learning)")
    print("⏰ Auto-Delete: 6 SECONDS (Dopamine Emojis)")
    ...
    print("✅ DOPAMINE HIT EMOJIS: 5 WIN + 5 LOSS Variations (6s Auto-Delete)")
