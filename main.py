# ==========================================
# 🌌 AURA BOT v7.0 - FINAL COMPLETE (FIXED PERIOD)
# ==========================================
...
async def set_period(update, context):
    try:
        ...
        if len(period) == 4 and period.isdigit():
            ...
            # ⭐ CLEAR waiting_period FIRST to prevent duplicate
