# ==========================================
# 🌌 AURA BOT v9.0 - COMPLETE WITH REAL TIME SYNC + LEADERBOARD ARROWS
# ==========================================
...
# ==========================================
# ⭐ TIMER SELECT - REAL TIME SYNC (FIXED)
# ==========================================
async def timer_select(update, context):
    try:
        ...
        if text in timer_map:
            ...
            # ✅ Clean timer message (Auto-delete 3s)
            ...
            # ✅ Show PERIOD ENTRY BANNER (Permanent - No auto-delete)
...
# ==========================================
# ⭐ SET PERIOD - REAL TIME CHECK (FIXED)
# ==========================================
async def set_period(update, context):
    try:
        ...
        if remaining > 0:
            ...
            # ⚠️ ONLY THIS MESSAGE AUTO-DELETES
        ...
        if len(period) == 4 and period.isdigit():
            ...
            # ✅ Show RESULT ENTRY BANNER (Permanent - No auto-delete)
...
# ==========================================
# ⭐ HANDLE RESULT NUMBER - FINAL TIME CHECK (FIXED)
# ==========================================
async def handle_result_number(update, context):
    try:
        ...
        if text in number_map:
            ...
            # ✅ Now process analysis - shows prediction banner
...
"""
            ...
            await update.message.reply_text(result_msg, parse_mode='Markdown', reply_markup=result_keyboard)
